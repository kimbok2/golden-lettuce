    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_img', models.ImageField(default='image/userdefault.png', upload_to='image/')),
                ('budget', models.IntegerField(blank=True, null=True)),
                ('salary', models.IntegerField(blank=True, null=True)),
                ('address', models.TextField(blank=True, null=True)),
                ('deposit_able', models.IntegerField(blank=True, null=True)),
                ('saving_able', models.IntegerField(blank=True, null=True)),
