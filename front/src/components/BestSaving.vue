<template>
    <div>
      <div class="tab-content" id="productTabContent">
        ...
        >
          <div id="carouselSaving" class="carousel slide no-top-border-radius">
              ...
              >
                <div class="card no-top-border-radius">
                  <div class="card-body vertical-align">
                    ...
                    <h6 class="card-text">{{ bank.top_saving_product.fin_prdt_nm }}</h6>
                    <p class="card-text">가입자 수 : {{ bank.top_saving_product.user_count }}명</p>
                    <p class="card-text">
                    ...
                    <RouterLink
                      :to="{
                        ...
                        params: { id: bank.top_saving_product.id, type: 'saving' },
                      }"
  ...
  const handleCarouselClick = (event) => {
    const carousel = document.getElementById("carouselSaving");
